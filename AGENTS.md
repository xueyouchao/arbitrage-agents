...
This project is indexed by GitNexus as **arbitrage-agents** (1574 symbols, 2920 relationships, 94 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
