...
This project is indexed by GitNexus as **arbitrage-agents** (956 symbols, 2309 relationships, 77 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
